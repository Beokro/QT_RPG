...
Game::Game(QWidget *parent)
{
    ...
    show();
        ...
        vector<int>temp1;
        Life pony = Life("person", 1, 2, 3, 4, 5, 6, 7, 8,  temp1);
        Hero Saber = Hero("Saber", 1, 20, 10, 3, 4, 0,0,12, 16,  temp1);
        ...
        Monster monster_NO1("Imp", 11, 2, 4, 0, temp1, dpitems, 5, 5);
        ...
        Monster monster_NO2("Bat", 13, 1, 4, 2,  temp1, dpitems, 7, 7);

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Hero_t, stringdata) + ofs \
...
const QMetaObject Hero::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Hero.data,
      qt_meta_data_Hero,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Hero.stringdata))
        return static_cast<void*>(const_cast< Hero*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< Hero*>(this));
    if (!strcmp(_clname, "Life"))
        return static_cast< Life*>(const_cast< Hero*>(this));
